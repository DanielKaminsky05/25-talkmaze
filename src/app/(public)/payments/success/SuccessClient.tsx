...
const useConfetti = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (frame < 120) {
        for (let k = 0; k < 6; k++) particles.push(createParticle());
        frame++;
      }
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 50px 100px -12px rgba(0, 0, 0, 0.25), inset 0 0 0 5px rgba(255, 255, 255, 0.2)",
          maxHeight: "90vh",
        }}
      >
        <div className="overflow-y-auto custom-scrollbar flex-grow flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-2xl bg-emerald-900/20 rounded-xl p-6 text-left space-y-5 border border-emerald-800/10 shadow-inner mb-8 text-emerald-50">
            <div>
              <strong className="text-white block mb-1 text-lg font-bold tracking-wide">
                Access Your Resources:
              </strong>
              <p className="text-emerald-50 leading-snug text-sm font-medium">
                Head to your account dashboard to explore our library of
            ...
            <div>
              ...
              <p className="text-emerald-50 leading-snug text-sm font-medium">
                Book your personalized one-on-one tutoring sessions with our
            ...
            <div>
              ...
              <p className="text-emerald-50 leading-snug text-sm font-medium">
                ...
                <a
                  href="mailto:hello@talkmaze.com"
                  className="underline decoration-1 underline-offset-2 hover:text-white font-bold"
                >
                  hello@talkmaze.com
                </a>
                .
            ...
            <div className="pt-4 border-t border-emerald-50/20 mt-2">
              <p className="text-emerald-50 leading-relaxed text-xs md:text-sm font-medium">
                Thank you for choosing TalkMaze! We're here to support you on
                your journey to becoming a confident and compelling public
                speaker!
              </p>
            </div>
          </div>
