...
// `next/image fill` needs a positioned, sized box - the `Avatar` root provides
// it.
// Renders nothing when there's no source or the current source has failed,
// which reveals the `AvatarFallback` beneath.
...
/*Sits behind the image; visible while the image loads, is absent, or has failed
 Renders its children or a generic user icon when given none.*/
