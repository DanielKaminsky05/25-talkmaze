/**
 * Contract tests for PATCH /api/parent/setup.
 *
...
import { PATCH as setupPATCH } from "@/src/app/api/parent/setup/route";
...
describe("PATCH /api/parent/setup — input validation", () => {
...
describe("PATCH /api/parent/setup — response shape", () => {
...
describe("PATCH /api/parent/setup — side effects", () => {
