/**
 * Contract tests for GET /api/parent/students/[studentId].
 *
...
// Q1
describe("GET /api/parent/students/[studentId] — ownership", () => {
...
// Q2
describe("GET /api/parent/students/[studentId] — input validation", () => {
...
// Q3
describe("GET /api/parent/students/[studentId] — response shape", () => {
