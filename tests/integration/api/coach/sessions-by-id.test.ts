/**
 * Contract tests for PATCH /api/coach/sessions/[id].
 *
...
import { PATCH as sessionPATCH } from "@/src/app/api/coach/sessions/[id]/route";
...
// Q1
describe("PATCH /api/coach/sessions/[id] — ownership", () => {
...
// Q2
describe("PATCH /api/coach/sessions/[id] — input validation", () => {
...
// Q3
describe("PATCH /api/coach/sessions/[id] — response shape", () => {
...
// Q4
describe("PATCH /api/coach/sessions/[id] — side effects", () => {
