/**
 * Contract tests for PATCH /api/coach/lesson-progress.
 *
...
describe("PATCH /api/coach/lesson-progress — ownership", () => {
...
describe("PATCH /api/coach/lesson-progress — input validation", () => {
...
describe("PATCH /api/coach/lesson-progress — response shape", () => {
...
describe("PATCH /api/coach/lesson-progress — side effects on lesson_progress", () => {
...
describe("PATCH /api/coach/lesson-progress — side effects on student_tokens", () => {
...
describe("PATCH /api/coach/lesson-progress — side effects on student_badges", () => {
