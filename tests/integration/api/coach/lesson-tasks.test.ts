/**
 * Contract tests for PATCH /api/coach/lesson-tasks.
 *
...
import { PATCH as lessonTasksPATCH } from "@/src/app/api/coach/lesson-tasks/route";
...
describe("PATCH /api/coach/lesson-tasks — ownership", () => {
...
describe("PATCH /api/coach/lesson-tasks — input validation", () => {
...
describe("PATCH /api/coach/lesson-tasks — upsert with description only", () => {
...
describe("PATCH /api/coach/lesson-tasks — delete-when-empty path", () => {
