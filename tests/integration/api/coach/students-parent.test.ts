/**
 * Contract tests for GET /api/coach/students/[studentId]/parent.
 *
 ...
 * Mirrors the response shape of GET /api/parent/students/[studentId];
...
import { GET } from "@/src/app/api/coach/students/[studentId]/parent/route";
...
// Q1
describe("GET /api/coach/students/[studentId]/parent — ownership", () => {
...
// Q2
describe("GET /api/coach/students/[studentId]/parent — input validation", () => {
...
// Q3
describe("GET /api/coach/students/[studentId]/parent — response shape", () => {
