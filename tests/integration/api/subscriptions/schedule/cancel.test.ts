/**
 * Contract tests for POST /api/subscriptions/schedule/cancel.
 *
...
describe("POST /api/subscriptions/schedule/cancel — ownership", () => {
...
describe("POST /api/subscriptions/schedule/cancel — input validation", () => {
...
describe("POST /api/subscriptions/schedule/cancel — response shape", () => {
...
describe("POST /api/subscriptions/schedule/cancel — side effects", () => {
...
describe("POST /api/subscriptions/schedule/cancel — external calls", () => {
