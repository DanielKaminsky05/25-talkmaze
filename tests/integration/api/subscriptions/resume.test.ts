/**
 * Contract tests for POST /api/subscriptions/resume.
 *
...
describe("POST /api/subscriptions/resume — ownership", () => {
...
describe("POST /api/subscriptions/resume — input validation", () => {
...
describe("POST /api/subscriptions/resume — response shape", () => {
...
describe("POST /api/subscriptions/resume — side effects", () => {
...
describe("POST /api/subscriptions/resume — external calls", () => {
