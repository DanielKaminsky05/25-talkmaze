/**
 * Contract tests for POST /api/admin/courses/assign.
 *
...
import { POST as assignPOST } from "@/src/app/api/admin/courses/assign/route";
...
// Q2
describe("POST /api/admin/courses/assign — input validation", () => {
...
// Q3
describe("POST /api/admin/courses/assign — response shape", () => {
...
// Q4
describe("POST /api/admin/courses/assign — side effects", () => {
