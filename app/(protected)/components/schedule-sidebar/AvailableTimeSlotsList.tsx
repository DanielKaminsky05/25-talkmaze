      ...
      {timeSlots.map((timeSlot) => {
        ...
        return (
          <div
            ...
            className={`w-full h-[72px] p-4 border-[0.5px] rounded-xl font-semibold border-[#4E4C4C] shadow-[inset_0px_4px_4px_rgba(0,0,0,0.25)] flex justify-between items-center cursor-pointer ${
              isSelected
